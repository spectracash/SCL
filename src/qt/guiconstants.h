...
/* Spectra GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Spectra"
#define QAPP_ORG_DOMAIN "spectra.cash"
#define QAPP_APP_NAME_DEFAULT "Spectra-Qt"
#define QAPP_APP_NAME_TESTNET "Spectra-Qt-testnet"
