...
"""Verify that starting scl with -h works as expected."""
import subprocess
...
class HelpTest(PivxTestFramework):
    ...
    def run_test(self):
        self.log.info("Start scl with -? for help text")
        ...
        self.log.info("Start scl with -version for version information")
