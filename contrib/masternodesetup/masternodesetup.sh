...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='scl.conf'
CONFIGFOLDER='/root/.scl'
COIN_DAEMON='scld'
COIN_CLI='scl-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ=`curl -s https://api.github.com/repos/Spectra/Spectra/releases/latest | grep "browser_download_url.*Linux\\.tar.gz" | cut -d : -f 2,3 | tr -d \" | xargs`
