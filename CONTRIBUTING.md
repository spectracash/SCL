Contributing to SpectraCash Core
============================

The SpectraCash Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/Spectra/Spectra/blob/master/doc/translation_process.md)
...
The following applies to code changes to the SpectraCash Core project, and is not to be
confused with overall Spectra Network Protocol consensus changes.

Whether a pull request is merged into SpectraCash Core rests with the project merge
...
Patches that change Spectra consensus rules are considerably more involved than
...
Where a patchset proposes to change the Spectra consensus, it must have been
...
The project leader is the release manager for each SpectraCash Core release.
