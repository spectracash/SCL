...
{
    const char* pszTimestamp = "Cryptocurrency designed for a diverse range of applications";
    const CScript genesisOutputScript = CScript() << ParseHex("042f2c02c0a3fd47cb2c41ffd92bf6c736e536b3641a7fdc573db35a9585bf0000e8add437e7592b9f4e85884853f0ade0e71c695cae6ae443b7901a9385fa91e4") << OP_CHECKSIG;
...
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1697688185, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        //  uint32_t nGenesisTime = 1697688185;
        //  arith_uint256 test;
        //  bool fNegative;
        //  bool fOverflow;
        ...
        genesis = CreateGenesisBlock(1697688185, 508506, 0x1e0ffff0, 1, 0 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x000005bc5d5968eed370fe807659a79d43fd6fe25385b2272b0e0292a5f716b0"));
        assert(genesis.hashMerkleRoot == uint256S("0x6e9c5d3932ec05e98fb212c3c99ce179f03d5d172dff9cb9cd88a3d91e1a73f6"));
        ...
        // spork keys
        consensus.strSporkPubKey = "042c139345217c3e05eb6dc7f511d569b3919e8c614344b5dc858bd21acbfef27345e8364587ad6fe06baabad157eaf32ad255a82ff6c5edc68fc30c84430e19b8";
        consensus.strSporkPubKeyOld = "";
        consensus.nTime_EnforceNewSporkKey = 0;
        consensus.nTime_RejectOldSporkKey = 0;

        // dev address
        consensus.devAddress = "CetZPfVDEp2zS9qXnsu8EdNLoyU4bFPri8";
        ...
        vSeeds.push_back(CDNSSeedData("seed1", "seed1.spectra.cash"));
        vSeeds.push_back(CDNSSeedData("seed2", "seed2.spectra.cash"));
        vSeeds.push_back(CDNSSeedData("seed3", "seed3.spectra.cash"));
        vSeeds.push_back(CDNSSeedData("seed4", "seed4.spectra.cash"));
	    vSeeds.push_back(CDNSSeedData("seed5", "seed5.spectra.cash"));
	    vSeeds.push_back(CDNSSeedData("seed6", "seed6.spectra.cash"));
	    vSeeds.push_back(CDNSSeedData("seed7", "seed7.spectra.cash"));
	    vSeeds.push_back(CDNSSeedData("seed8", "seed8.spectra.cash"));

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 28);
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 63);
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 48);
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0xbb)(0xda)(0x11)(0xd3).convert_to_container<std::vector<unsigned char> >();
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0xbb)(0xda)(0x5f)(0xc3).convert_to_container<std::vector<unsigned char> >();
        // BIP44 coin type is from https://github.com/satoshilabs/slips/blob/master/slip-0044.md
        base58Prefixes[EXT_COIN_TYPE] = boost::assign::list_of(0x80)(0x00)(0x02)(0xf7).convert_to_container<std::vector<unsigned char> >();
...
public:
    CTestNetParams()
    {
        ...
        consensus.powLimit   = ~UINT256_ZERO >> 20;   // scl starting difficulty is 1 / 2^12
        consensus.posLimitV1 = ~UINT256_ZERO >> 24;
        consensus.posLimitV2 = ~UINT256_ZERO >> 20;
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 65); // Testnet scl addresses start with 'T'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 66);  // Testnet scl script addresses start with 'T'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet scl BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet scl BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet scl BIP44 coin type is '1' (All coin's testnet default)
