...
* Update manpages, see [gen-manpages.sh](https://github.com/Spectra/Spectra/blob/master/contrib/devtools/README.md#gen-manpagessh).
...
Check out the source code in the following directory hierarchy.
    ...
    git clone https://github.com/Spectra/Spectra-detached-sigs.git
