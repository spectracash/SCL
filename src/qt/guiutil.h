...
/** Utility functions used by the Spectra Qt UI.
 */
namespace GUIUtil
{
...
// Render SCL addresses in monospace font
...
// Parse "scl:" URI into recipient object, return true on successful parsing
