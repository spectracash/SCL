...
#define MyAppPublisher "2022 Spectra developers"
#define MyAppURL "https://spectra.cash/"
#define MyAppExeName "scl-qt.exe"
//#define MyAppExtraData "https://explorer.decenomy.net/bootstraps/SCL/bootstrap.zip"
...
OutputDir=.\output
OutputBaseFilename=SpectraSetup
...
DefaultGroupName=SpectraCash Core
...
[Files]
Source: ".\package\scl-qt.exe"; DestDir: "{app}"; Flags: ignoreversion; Components: app
...
[Registry]
Root: "HKCU"; Subkey: "Software\Spectra\Spectra-Qt"; ValueType: string; ValueName: "strDataDir"; ValueData: "{code:GetDataDir}\"
...
begin
  ...
  if DataDirPage.Values[0] = '' then
     DataDirPage.Values[0] := ExpandConstant('{reg:HKCU\Software\Spectra\Spectra-Qt,strDataDir|{userappdata}\Spectra\}');
  Result := True;
end;
