...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* SCL features */
        {"scl", "listmasternodes", &listmasternodes, true },
        {"scl", "getmasternodecount", &getmasternodecount, true },
        {"scl", "createmasternodebroadcast", &createmasternodebroadcast, true },
        {"scl", "decodemasternodebroadcast", &decodemasternodebroadcast, true },
        {"scl", "relaymasternodebroadcast", &relaymasternodebroadcast, true },
        {"scl", "masternodecurrent", &masternodecurrent, true },
        {"scl", "startmasternode", &startmasternode, true },
        {"scl", "createmasternodekey", &createmasternodekey, true },
        {"scl", "getmasternodeoutputs", &getmasternodeoutputs, true },
        {"scl", "listmasternodeconf", &listmasternodeconf, true },
        {"scl", "getmasternodestatus", &getmasternodestatus, true },
        {"scl", "getmasternodewinners", &getmasternodewinners, true },
        {"scl", "getmasternodescores", &getmasternodescores, true },
        {"scl", "preparebudget", &preparebudget, true },
        {"scl", "submitbudget", &submitbudget, true },
        {"scl", "mnbudgetvote", &mnbudgetvote, true },
        {"scl", "getbudgetvotes", &getbudgetvotes, true },
        {"scl", "getnextsuperblock", &getnextsuperblock, true },
        {"scl", "getbudgetprojection", &getbudgetprojection, true },
        {"scl", "getbudgetinfo", &getbudgetinfo, true },
        {"scl", "mnbudgetrawvote", &mnbudgetrawvote, true },
        {"scl", "mnfinalbudget", &mnfinalbudget, true },
        {"scl", "checkbudgets", &checkbudgets, true },
        {"scl", "mnsync", &mnsync, true },
        {"scl", "spork", &spork, true },
        {"scl", "getcollateral", &getcollateral, true},
...
{
    return "> scl-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:22780/\n";
}
