...
scl.conf           | contains configuration settings for scld or scl-qt
scld.pid           | stores the process id of scld while running
...
debug.log           | contains debug information and general logging generated by scld or scl-qt
