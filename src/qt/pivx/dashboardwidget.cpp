    ...
    ui(new Ui::DashboardWidget)
{
    ...
    // Staking Information
    ui->labelMessage->setText(tr("Amount of SCL earned via Staking & Masternodes"));
	...
	ui->labelAmountMNRewards->setText("0 SCL");
...
bool DashboardWidget::loadChartData(bool withMonthNames)
{
    ...
    chartData->amountsByCache = getAmountBy(); // pair SCL, zSCL
...
void DashboardWidget::onChartRefreshed()
{
    ...
    set0->setColor(QColor(250, 191, 118));
	set1->setColor(QColor(243, 11, 144));
